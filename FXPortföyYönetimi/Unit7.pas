...
uses
  ...
  Data.DB, Data.Win.ADODB, Vcl.Grids, Vcl.DBGrids, Vcl.Mask, Vcl.ExtCtrls,
  Vcl.ComCtrls;
...
adotable1.First;
repeat
  toplam:=toplam+adotable1.FieldByName('PotansiyelGetiriOrani').AsCurrency;
  inc(adet);
  ortalama:=toplam/adet;
  adotable1.next;
until(adotable1.eof);
